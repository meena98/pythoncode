...
def test_classes_are_object_factories():
    ...
    q2 = TestQueue()
    assert type(q1) == q1.__class__
    assert type(q2) == q2.__class__
...
def test_classes_init_with_args():
    ...
    try:
        q3 = TestQueue()
    except BaseException: #what error do you get?
        pass
...
def test_classes_bound_and_unbound_methods():
    ...
    try:
        ...
        assert __ == q1_push.__self__  # bound method, is associated
        # with an
        #  instance
...
def test_instances_state():
    ...
    except BaseException: # fill up the exception you got
        assert True

    try:
        age = r1.age
        assert False, "Should not reach here"
    except BaseException: #what exception do you get?
        assert True
